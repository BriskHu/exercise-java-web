            ...
            if (msg instanceof String) {
                ...
                if (deviceLoginReqDto != null) {
                    ...
                    if (deviceSn != null) {
                        ...
                        String ip = (String) redisTemplate.opsForHash().get(RedisKey.Device.D_AUTH + deviceSn, RedisKey.F_IP);
                        if (StringUtils.isEmpty(ip) || !clientIp.equals(ip)) {
                            ...
                            redisTemplate.opsForHash().put(RedisKey.Device.D_AUTH + deviceSn, RedisKey.F_IP, clientIp);
